...
"-webkit-transform:"+b+";-moz-transform:"+b+";transform:"+b+";"}};(function(){g=window.innerHeight;l();for(var a=0;a<c.elems.length;a++){var b=p(c.elems[a]);d.push(b)}window.addEventListener("resize",function(){k()});m();k()})();Object.freeze(c);return c}};return e});
